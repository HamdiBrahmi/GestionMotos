...
public class MotoServiceImpl implements MotoService {
	...
	@Override
	public List<Moto> findByCategorie(Categorie categorie) {
		return motoRepository.findByCategorie(categorie);
	}

	@Override
	public List<Moto> findByCategorieIdCat(Long id) {
		return motoRepository.findByCategorieIdCat(id);
	}
